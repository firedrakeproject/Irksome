...
from fetsome.galerkin_in_time.burgers_diffusion.burgers_nu import solve_burgers_nu
from argparse import ArgumentParser

import numpy as np

# Parser setup to run the script
parser = ArgumentParser("python3 burgers_graph.py", description="Solve and plot a viscous 1d Burgers equation "
                        "on continuous spatial elements")
...
if __name__ == "__main__":
    ...
    us = solve_burgers_nu(Ns, dt, tmax, kt, generator_code, info=True)
