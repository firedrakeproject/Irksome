...
parser = ArgumentParser("python3 heat1d_graph.py", description="Solve and plot the analytic "
...
parser.add_argument("dt", type=float, nargs=1,
                    help="Timestep size for the temporal discretisation (sugg. 0.625)")
